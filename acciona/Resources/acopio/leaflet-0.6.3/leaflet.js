!function(t, e, i) {
    var n = t.L, o = {};
    o.version = "0.6.3", "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), 
    ...
    function() {
        ...
        setMaxBounds: function(t, e) {
            ...
            return this._boundsMinZoom = i, this._loaded && (i > this._zoom ? this.setView(t.getCenter(), i, e) : this.panInsideBounds(t)), 
        ...
        removeLayer: function(t) {
            var e = o.stamp(t);
            if (this._layers[e]) return this._loaded && t.onRemove(this), delete this._layers[e], 
            this._loaded && this.fire("layerremove", {
                layer: t
            }), this._zoomBoundLayers[e] && (delete this._zoomBoundLayers[e], this._updateZoomLevels()), 
            this.options.zoomAnimation && o.TileLayer && t instanceof o.TileLayer && (this._tileLayersNum--, 
            this._tileLayersToLoad--, t.off("load", this._onTileLayerLoad, this)), this;
        },
        hasLayer: function(t) {
        ...
        getMinZoom: function() {
            var t = this._layersMinZoom === i ? -1 / 0 : this._layersMinZoom, e = this._boundsMinZoom === i ? -1 / 0 : this._boundsMinZoom;
        ...
        _addTilesFromCenterOut: function(t) {
            ...
            for (i = t.min.y; t.max.y >= i; i++) for (n = t.min.x; t.max.x >= n; n++) s = new o.Point(n, i), 
        ...
        _removeOtherTiles: function(t) {
            ...
            (t.min.x > i || i > t.max.x || t.min.y > n || n > t.max.y) && this._removeTile(o);
        },
        ...
        _initIcon: function() {
            ...
            this._shadow = r, 1 > t.opacity && this._updateOpacity();
        ...
        _adjustPan: function() {
            if (this.options.autoPan) {
                ...
                s.x + i > r.x && (h = s.x + i - r.x + a.x), 0 > s.x - h && (h = s.x - a.x), s.y + e > r.y && (l = s.y + e - r.y + a.y), 
                0 > s.y - l && (l = s.y - a.y), (h || l) && t.fire("autopanstart").panBy([ h, l ]);
            }
        },
    ...
    o.Map.mergeOptions({
        ...
        _onMouseDown: function() {
            if (!this._focused) {
                var i = e.body, n = e.documentElement, o = i.scrollTop || n.scrollTop, s = i.scrollTop || n.scrollLeft;
